...
function helloColorChange(event){
...
function helloBtnOg(event){
    sayHelloButton.style.backgroundColor = '#EFEFEF';
    sayHelloButton.style.color = 'black';
}
sayHelloButton.addEventListener('mouseout',helloBtnOg)
...
function getQuery (){
    axios.get(`http://localhost:3000/query-test/?animals=Dogs `)
    .then(res =>{
    ...
    axios.get(`http://localhost:3000/query-test/?animals=dogs&plants=flower `)
    .then(res =>{
        console.log(res.data)
    })
}
